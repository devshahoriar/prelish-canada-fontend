                ...
                <section className="py-6">
                    ...
                    <div className="card border-0 shadow-xxs-2">
                      ...
                      >
                        ...
                        >
                          ...
                          <ul className="list-inline mb-0 d-none d-sm-block pr-2">
                            <li className=" list-inline-item text-muted mr-4">
                              Beds :{' '}
                              <span className="font-weight-500 text-heading">
                                2
                              </span>
                            </li>
                            <li className=" list-inline-item text-muted mr-4">
                      ...
                      >
                        <div className="card-body card-body col-sm-6 offset-sm-3 mb-3">
                          <img
                            src="images/single-detail-property-01.jpg"
                            className="card-img"
                            alt="Floor Plans"
                          />
                        </div>
                  ...
                  >
                    <div className="card border-0 shadow-xxs-2">
                      ...
                      >
                        <div
                          className="heading d-flex justify-content-between align-items-center px-6 collapsed "
                          data-toggle="collapse"
