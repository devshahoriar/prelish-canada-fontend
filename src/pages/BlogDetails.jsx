        ...
        <section className="pt-13 pb-12">
          <div className="container">
            <div className="row ml-xl-0 mr-xl-n6">
              <div className="col-lg-8 mb-6 mb-lg-0 pr-xl-6 pl-xl-0">
                ...
                <ul className="list-inline mt-4">
                  ...
                  <li className="list-inline-item mr-4">
                    <i className="far fa-calendar mr-1" /> 30th Dec, 2020
                  </li>
                  <li className="list-inline-item mr-4">
                ...
                <div className="lh-214 mb-9">
                  ...
                  <p className="ml-8 pl-4 fs-16 text-heading font-weight-500 lh-2 border-left border-4x border-primary mxw-521 my-6">
                    GrandHome is an estate agency that helps people live in more
                    thoughtful and beautiful ways. We believe in design as a
                  ...
                  <p>
                    ...
                    ipsum dolor sit amet datat non proident, sunt in culpa qui
                    officia deserunt mollit anim id est laboruore Duis autem vel
                    eum iriure dolor in hendvelit esse molestie consequat, est
                    usus legentis vel illum dolore eu feugiat nulla...
                  </p>
                  <p>
                ...
                <div className="row pb-7 mb-6 border-bottom">
                  <div className="col-sm-6 d-flex">
                    ...
                    <ul className="list-inline">
                      <li className="list-inline-item mr-0">
                        <a href="#" className="text-muted hover-dark">
                          real estate,
                        </a>
                      </li>
                      <li className="list-inline-item mr-0">
                  ...
                  <div className="col-sm-6 text-left text-sm-right">
                    <span className="d-inline-block text-heading font-weight-500 lh-17 mr-1">
                      Share this post
                    </span>
                    <button
                      type="button"
                      className="btn btn-primary rounded-circle w-52px h-52 fs-20 d-inline-flex align-items-center justify-content-center"
                      data-container="body"
                      data-toggle="popover"
                      data-placement="top"
                      data-html="true"
            ...
            '
                ...
                <div className="media flex-wrap flex-sm-nowrap mb-8">
                  <div className="mb-3 mb-sm-0 mr-sm-2 text-center w-100 w-sm-auto">
                    <img src="/images/author-2.jpg" alt="Maggie Strickland" />
                    <ul className="list-inline mb-0 mt-3">
                      <li className="list-inline-item mr-0">
                        <a
                          href="#"
                          className="text-muted fs-15 hover-dark lh-1 px-2"
                        >
                  ...
                  <div className="media-body text-center text-sm-left">
                    <h5 className="text-dark fs-16 mb-2">Maggie Strickland</h5>
                    <p className="mb-0">
                      Excepteur sint occaecat cupidatat non proident, sunt in
                      culpa qui officia deserunt mollit anim id est laboruLorem
                ...
                <div className="row mb-7">
                  <div className="col-sm-6 mb-6">
                    <div className="card">
                      <img
                        src="/images/blog-nav-01.jpg"
                        alt="How to Create an Effective Elevator Pitch"
                        className="card-img"
                      />
                      <a
                        href="#"
                        className="card-img-overlay d-flex align-items-center justify-content-center text-white fs-16 font-weight-500 px-4 pl-sm-5 pr-sm-8 py-6"
                      >
                        <span className="d-inline-block mr-4 fs-24">
                  ...
                  <div className="col-sm-6 mb-6">
                    <div className="card">
                      <img
                        src="/images/blog-nav-02.jpg"
                        alt="How to Create an Effective Elevator Pitch"
                        className="card-img"
                      />
                      <a
                        href="#"
                        className="card-img-overlay d-flex align-items-center justify-content-center text-white fs-16 font-weight-500 px-4 pr-sm-5 pl-sm-10 py-6 text-right"
                      >
                        Top Strategic Technology Trends for 2019
                        <span className="d-inline-block ml-4 fs-24">
                ...
                <div className="media mb-6 pb-5 border-bottom">
                  ...
                  <div className="media-body">
                    <p className="text-heading fs-16 font-weight-500 mb-0">
                      Dollie Horton
                    </p>
                    <p className="mb-4">
                      Very good and fast support during the week. Thanks for
                      always keeping your WordPress themes up to date. Your
                      level of support and dedication is second to none. Solved
                      all my problems in a pressing time! Excited to see the
                      other themes they make!
                    </p>
                    <ul className="list-inline">
                      <li className="list-inline-item text-muted">
                        02 Dec 2019 at 2:40pm
                        <span className="d-inline-block ml-2">|</span>
                      </li>
                ...
                <h3 className="fs-22 text-heading lh-15 mb-6">
                ...
                <form>
                  ...
                  <button type="submit" className="btn btn-lg btn-primary px-9">
                    Submit
                  </button>
                </form>
              </div>
