          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-8">
                <h2 className="text-heading fs-22 lh-15 mb-5">
                  Services Offered
                </h2>
                <div className="row mb-8">
                  ...
                  <div className="col-sm-6 col-md-4 mb-6">
                    <div className="card border-0">
                      <div className="hover-flash card-img-top">
                        <img src="images/image-box-8.jpg" alt="Home Buying" />
                      </div>
                      <div className="card-body px-0 pt-2 pb-0">
                        <h4 className="card-title fs-18 lh-17 text-dark mb-0">
                          Home Buying
                ...
                <div className="pb-7 pb-lg-0">
                  <h2 className="text-heading mb-4 fs-22 lh-15 pr-6">
              ...
              >
                <div className="primary-sidebar-inner">
                  ...
                  <div className="card mb-4 property-widget">
                  ...
                  <div className="card">
                    <div className="card-body px-6 py-4">
                      <h4 className="card-title fs-16 lh-2 text-dark mb-2">
                        Agents
                      </h4>
                      <ul className="list-group list-group-flush">
                        <li className="list-group-item px-0 pb-4 pt-0">
                          <div className="media align-items-center">
                            ...
                            <div className="media-body">
                              <a
                                href="#"
                                className="d-block text-dark font-weight-500 lh-2 hover-primary"
                              >
                                Oliver Beddows
                              </a>
                              ...
                              <p className="mb-0 fs-13 mb-0 lh-17 text-heading font-weight-500">
                                (+68)1221 09876
                              </p>
                            </div>
                          </div>
                        </li>
                        <li className="list-group-item px-0 pt-3 pb-4">
                          <div className="media align-items-center">
                            <a
                              href="agent-details-1.html"
                              className="d-block w-60px h-60 mr-3"
...
export default ServicesWithSidebar
