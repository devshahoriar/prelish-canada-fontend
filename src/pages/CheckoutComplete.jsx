...
const CheckoutComplete = () => {
  return (
    <>
      ...
      <main id="content">
        <section className="pb-4 shadow-xs-5">
          <div className="container mt-13">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb pt-6 pt-lg-0 mb-4">
            ...
            <h1 className="fs-30 lh-1 mb-0 text-heading font-weight-600 mb-6">
              Payment Invoice
            </h1>
          </div>
        </section>
        <section className="pt-8 pb-11">
          <div className="container">
            <div className="row">
              <div className="col-lg-4 col-md-5 col-sm-8 mb-6 mb-md-0">
                <h4 className="text-heading fs-22 font-weight-500 lh-15">
                  Selected Package
                </h4>
                <div className="card border-0">
                  <div className="card-header bg-transparent d-flex justify-content-between align-items-center px-0 pb-3">
                    <p className="fs-15 font-weight-bold text-heading mb-0 text-uppercase mr-2">
                      Premium <span className="font-weight-500">Pack</span>
                    </p>
                    <a
                      href="#"
                      className="btn btn-outline-primary py-2 lh-238 px-4"
                    >
                      Change Package
                    </a>
                  </div>
                  <div className="card-body px-0 py-2">
                    <ul className="list-unstyled mb-0">
                      <li className="d-flex justify-content-between lh-22">
                        <p className="text-gray-light mb-0">Package Time:</p>
                        <p className="font-weight-500 text-heading mb-0">
                          01 year
                        </p>
                      </li>
                      <li className="d-flex justify-content-between lh-22">
                        ...
                        <p className="font-weight-500 text-heading mb-0">100</p>
                      </li>
                      <li className="d-flex justify-content-between lh-22">
                        <p className="text-gray-light mb-0">
                          Featured Listing Included:
                        </p>
                        <p className="font-weight-500 text-heading mb-0">50</p>
                      </li>
                    </ul>
                  </div>
                  <div className="card-footer bg-transparent d-flex justify-content-between p-0 align-items-center">
                    <p className="text-heading mb-0">Total Price:</p>
                    <span className="fs-32 font-weight-bold text-heading">
                      $80
                    </span>
                  </div>
                </div>
              ...
              <div className="col-md-7 offset-lg-1">
                ...
                <p className="mb-5 pr-xl-17">
                  Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe
                  ndisse suscorem ipsum dolor sit ametcipsu
                </p>
                <div className="custom-control custom-radio mb-2">
                  ...
                  <label
                    htmlFor="paypal"
                    className="font-weight-500 mb-0 custom-control-label"
                  >
                    <span className="fs-12 text-heading d-inline-block mr-1">
                ...
                <div className="custom-control custom-radio mb-2">
                  ...
                  <label
                    ...
                    className="font-weight-500 mb-0 custom-control-label"
                  >
                    <span className="text-heading fs-12  d-inline-block mr-1">
                      <i className="fas fa-paper-plane" />
                    </span>
                    Wire Transfer
                  </label>
                </div>
                <p className="text-heading font-weight-500 mb-0 pt-1">
                  Lorem ipsum dolor sit amet, consec tetur cing elit.
                </p>
                <p className="mb-2 text-gray-light">
                  Suspe ndisse suscorem ipsum dolor sit ametcipsu Ipsam minus
                  provident quam.
                </p>
                <p className="mb-4 text-gray-light">
                  Ab, aliquam at commodi consequuntur corporis dolorum ex
                  expedita facilis id necessitatibus neque nobis officiis
                  possimus praesentium quaerat quasi quod recusandae similique
                  tempore vel? Aliquam cum numquam pariatur recusandae
                  reiciendis repellat voluptatibus? Ab ad aut doloribus est ex
                  explicabo facere facilis id inventore neque, nulla odit
                  praesentium quia quod veritatis? Alias aliquid aspernatur
                  culpa cupiditate ducimus esse nobis qui voluptas. A
                  consectetur consequuntur, eius enim necessitatibus omnis optio
                  pariatur temporibus tenetur ullam. Aliquid architecto
                  explicabo, facere impedit necessitatibus nostrum quaerat
                  suscipit!
                </p>
                <p className="mb-6">
                  Please read{' '}
                  <a
                    href="#"
                    className="text-heading font-weight-500 border-bottom hover-primary"
                  >
                    Term &amp; Conditions
                  </a>{' '}
                  first
                ...
                <a
                  href="checkout-complete-2.html"
                  className="btn btn-primary px-8 py-2 lh-238"
                >
                  Pay Now
                </a>
              </div>
