          ...
          <div className="container">
            <div className="row ml-xl-0 mr-xl-n6">
              <div className="col-lg-8 mb-6 mb-lg-0 pr-xl-6 pl-xl-0">
                <div className="card border-0 mb-6 pb-6 border-bottom">
                  <div className="row no-gutters align-items-lg-center h-100">
                    <div className="d-flex align-items-end col-md-6 p-0">
                      ...
                      <a
                        href="blog-details-1.html"
                        className="badge text-white bg-dark-opacity-04 fs-13 m-2 font-weight-500 bg-hover-primary hover-white position-absolute pos-fixed-bottom"
                      >
                        creative
                      </a>
                    </div>
                    <div className="col-md-6">
                      <div className="card-body pl-md-6 px-0 pt-5 pt-md-0 pb-0">
                        ...
                        <h3 className="fs-18 text-heading lh-194 mb-1">
                          ...
                          >
                            Future Office Buldings Intelligent by Design
                          </a>
                        </h3>
                        <p className="mb-lg-7">
                        ...
                        <a className="text-heading font-weight-500" href="#">
                          Learn more{' '}
                      ...
                      <div className="card-body pl-md-6 px-0 pt-5 pt-md-0 pb-0">
                        ...
                        <h3 className="fs-18 text-heading lh-194 mb-1">
                          <a
                            ...
                            className="text-heading hover-primary"
                          >
                            Ten Benefits Of Rentals That May Change Your
                            Perspective
                          </a>
                        </h3>
                        <p className="mb-lg-7">
                      ...
                      <div className="card-body pl-md-6 px-0 pt-5 pt-md-0 pb-0">
                        ...
                        <h3 className="fs-18 text-heading lh-194 mb-1">
                          <a
                            ...
                            className="text-heading hover-primary"
                          >
                            The Interior Design The Hall On str. Filimonovo
                          </a>
                        </h3>
                        <p className="mb-lg-7">
                          Massa tempor nec feugiat nisl pretium. Egestas
...
export default BlogListWidthSidebar
