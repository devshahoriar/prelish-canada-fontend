...
const SingleProperty = () => {
  return (
    <>
            ...
            <div className="d-flex align-items-center">
              <nav className="navbar navbar-expand-xl bg-transparent px-0 w-100 w-xl-auto">
                ...
                >
                  <ul className="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
                    ...
                    >
                      <a
                        className="nav-link text-dark dropdown-toggle p-0"
                        href="#"
              ...
              <div className="ml-auto d-none d-xl-block">
                <ul className="navbar-nav flex-row ml-auto align-items-center justify-content-lg-end flex-wrap py-2">
                  <li className="nav-item dropdown">
                    <a
                      className="nav-link text-dark dropdown-toggle mr-md-2 pr-2 pl-0 pl-lg-2"
                      href="#"
                      id="bd-versions"
                      data-toggle="dropdown"
                      aria-haspopup="true"
                  ...
                  <li className="nav-item">
                    <a
                      className="btn btn-outline-dark btn-lg text-dark rounded-lg bg-hover-primary border-hover-primary hover-dark d-none d-lg-block add-listing-button"
                      href="dashboard-add-new-property.html"
                    >
                      Add listing
                      <img
      ...
      <main id="content">
        <section>
          <div className="container single-page-margin">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb pt-lg-0 pb-3 mt-4">
                ...
                <div className="col-lg-6 p-1">
                  <div className="item item-size-4-3">
                    <div className="card p-0 hover-zoom-in">
                      <a
                        href="images/single-property-lg-1.jpg"
                        className="card-img"
                        data-gtf-mfp="true"
                        data-gallery-id={1}
                        style={{
                          backgroundImage:
                            'url("images/single-property-2.jpg")',
                        }}
                      ></a>
                    </div>
                  </div>
                  ...
                  <div className="row m-n1">
                    <div className="col-md-6 p-1">
                      <div className="item item-size-4-3">
                        <div className="card p-0 hover-zoom-in">
                          <a
                            href="images/single-property-lg-2.jpg"
                            className="card-img"
                            data-gtf-mfp="true"
                            data-gallery-id={1}
                            style={{
                              backgroundImage:
                                'url("images/single-property-22.jpg")',
                            }}
                          ></a>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6 p-1">
                      <div className="item item-size-4-3">
                        <div className="card p-0 hover-zoom-in">
                          <a
                            href="images/single-property-lg-3.jpg"
                            className="card-img"
                            data-gtf-mfp="true"
                            data-gallery-id={1}
                            style={{
                              backgroundImage:
                                'url("images/single-property-3.jpg")',
                            }}
                          ></a>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6 p-1">
                      <div className="item item-size-4-3">
                        <div className="card p-0 hover-zoom-in">
                          <a
                            href="images/single-property-lg-4.jpg"
                            className="card-img"
                            data-gtf-mfp="true"
                            data-gallery-id={1}
                            style={{
                              backgroundImage:
                                'url("images/single-property-4.jpg")',
                            }}
                          ></a>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6 p-1">
                      <div className="item item-size-4-3">
                        <div className="card p-0 hover-zoom-in">
                          <a
                            href="images/single-property-lg-5.jpg"
                            className="card-img"
                            data-gtf-mfp="true"
                            data-gallery-id={1}
                            style={{
                              backgroundImage:
                                'url("images/single-property-5.jpg")',
                            }}
                          ></a>
                          <a
                            href="#"
              ...
              <article className="col-lg-8 pr-xl-7">
                <section className="pb-7 border-bottom">
                  <ul className="list-inline d-sm-flex align-items-sm-center mb-2">
                    <li className="list-inline-item badge badge-orange mr-2">
                      Featured
                    </li>
                    ...
                    <li className="list-inline-item mr-2 mt-2 mt-sm-0">
                      <i className="fal fa-clock mr-1" />2 months ago
                    </li>
                  ...
                  <p className="mb-0 lh-214">
                    ...
                    sem. Nibh mauris cursus mattis molestie a iaculis at erat
                ...
                <section className="pt-6 border-bottom pb-4">
                  ...
                  <ul className="list-unstyled mb-0 row no-gutters">
                    <li className="col-sm-3 col-6 mb-2">
                      <i className="far fa-check mr-2 text-primary" />
                      Balcony
                    </li>
                    <li className="col-sm-3 col-6 mb-2">
                      <i className="far fa-check mr-2 text-primary" />
                    ...
                    <div className="card-body p-0">
                      ...
                      <div className="media border-top pt-7 pb-6 d-sm-flex d-block text-sm-left text-center">
                        ...
                        <div className="media-body">
                          ...
                          <p className="mb-3 pr-xl-17">
                            Very good and fast support during the week. Thanks
                            for always keeping your WordPress themes up to date.
                            Your level of support and dedication is second to
                            none.
                          </p>
                          ...
                          <div className="row mb-1 align-items-center">
                            ...
                            <div className="col-sm-6">
                              <ul className="list-inline d-flex justify-content-sm-end justify-content-center mb-0">
                                ...
                                <li className="list-inline-item mr-1">
                                  <span className="text-border fs-12 lh-2">
                                    <i className="fas fa-star" />
                                  </span>
                                </li>
                              </ul>
                  ...
                  <div className="d-sm-flex">
                    <div className="w-sm-170 mb-sm-0 mb-6 mr-sm-6">
                      <div className="card text-center pt-4">
                        <img
                          src="images/single-detail-property-05.png"
                        ...
                        <div className="card-body p-0 mt-4">
                          ...
                          >
                            Download
                            <i className="far fa-arrow-alt-circle-down ml-1 text-primary" />
                          </a>
                        </div>
                      </div>
                    </div>
                    <div className="w-sm-170 mb-sm-0 mb-6 mr-sm-6">
                      <div className="card text-center pt-4">
                        <img
                          src="images/single-detail-property-06.png"
                          className="card-img card-img w-78px mx-auto"
                ...
                <section className="py-6 border-bottom">
                  ...
                  <div className="position-relative">
                    <div
                      ...
                      data-mapbox-access-token="pk.eyJ1IjoieGVtaXJvbiIsImEiOiJjbGt4bnhscnkwMzA4M2txcDF6djdtZnhyIn0.UcEQ1D90RBWwwj7rKl99pw"
                ...
                <section className="py-6 border-bottom">
                  <h4 className="fs-22 text-heading mb-5">
                    Mortgage calculator
                  </h4>
                  <form>
                    <div className="row">
                      <div className="col-md-6 mb-4">
                        ...
                        <div className="position-relative">
                          <input
                            ...
                            name="total-amount"
                          />
                          <span className="position-absolute pl-3 pos-fixed-left-center fs-13 font-weight-600">
                            $
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-4">
                        ...
                        <input
                          type="number"
                          className="form-control border-0 px-3 h-52"
                          defaultValue={25}
                          name="years"
                        />
                      </div>
                      ...
                      <div className="col-lg-6">
                        <div className="shadow-xxs-2 pt-1 pb-2 px-6 border-bottom border-primary border-5x rounded-lg">
                          <dl className="d-flex mb-0 justify-content-between py-2">
                            ...
                            <dd className="font-weight-500 text-heading mb-0">
                              $33
                            </dd>
                          </dl>
                ...
                <section className="pt-6 border-bottom chart">
                  <div className="card border-0 mb-6">
                    <div className="card-body p-0 collapse-tabs">
                      <div className="d-flex align-items-center mb-5">
                        ...
                        <ul
                          className="nav nav-pills nav-pills-01 justify-content-end d-none d-sm-flex"
                          role="tablist"
                        >
                          ...
                          >
                            ...
                            >
                              <div className="box px-1 py-4">
                                <div
                                  className="card pointer active border-0 shadow-xxs-1"
                              ...
                              <div className="box px-1 py-4">
                                <div
                                  className="card pointer border-0 shadow-xxs-1"
                              ...
                              <div className="form-check-label ml-2">
                                <div className="d-flex align-items-center">
                                  <a
                                    ...
                                    className="d-block w-60px h-60 mr-3"
                                  >
                                    <img
                                  ...
                                  <div>
                                    <a
                                      href="agent-details-1.html"
                                      className="d-block text-dark font-weight-500 lh-15 hover-primary"
                                    >
                                      Oliver Beddows
                                    </a>
                                    <p className="mb-0 fs-13 mb-0 lh-17">
                                      Sales Excutive
                                    </p>
                                    <p className="mb-0 fs-13 mb-0 lh-17">
                                      <span>(+123)</span>
                                      <span className="text-heading d-inline-block ml-2">
                                        1900 68668
                                      </span>
                                    </p>
                                  </div>
