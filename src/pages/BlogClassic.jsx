...
const BlogClassic = () => {
                ...
                >
                  <li className="dropdown-item dropdown dropright">
                    ...
                    >
                      <li className="dropdown-item active">
                        <a className="dropdown-link" href="blog-classic.html">
                          Blog classic
                        </a>
                      </li>
                      <li className="dropdown-item">
                      ...
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="blog-details-1.html">
                          Blog details 1
                        </a>
                      </li>
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="blog-details-2.html">
                          Blog details 2
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="dropdown-item dropdown dropright">
                    ...
                    >
                      ...
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="contact-us-2.html">
                          Contact us 2
                        </a>
                      </li>
                    </ul>
                  ...
                  <li className="dropdown-item dropdown dropright">
                    ...
                    >
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="agents-grid-1.html">
                          Agents grid 1
                        </a>
                      </li>
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="agents-grid-2.html">
                          Agents grid 2
                        </a>
                      </li>
                      <li className="dropdown-item">
                      ...
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="agents-list.html">
                          Agents list
                        </a>
                      </li>
                      <li className="dropdown-item">
                  ...
                  <li className="dropdown-item dropdown dropright">
                    ...
                    >
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="agency-grid.html">
                          Agency grid
                        </a>
                      </li>
                      <li className="dropdown-item">
                        <a className="dropdown-link" href="agency-list.html">
                          Agency list
                        </a>
                      </li>
                      <li className="dropdown-item">
  ...
  <main id="content">
    <section
      className="pt-2 pb-13 page-title bg-img-cover-center bg-white-overlay"
    ...
    >
      <div className="container">
        ...
        <h1
          className="fs-30 lh-15 mb-0 text-heading font-weight-500 text-center pt-10"
    ...
    <section className="pt-11 pb-13">
      <div className="container">
        <div className="row ml-xl-0 mr-xl-n6">
          <div className="col-lg-8 mb-8 mb-lg-0 pr-xl-6 pl-xl-0">
            <div className="card border-0 pb-6 mb-6 border-bottom">
              <div className="position-relative d-flex align-items-end card-img-top">
                <a href="blog-details-1.html" className="hover-shine d-block">
                  <img
                ...
                <a
                  href="#"
                  className="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white m-2 position-absolute letter-spacing-1 pos-fixed-bottom"
                >
                  rental
                </a>
              </div>
              <div className="card-body p-0">
                <ul className="list-inline mt-4">
                  ...
                  <li className="list-inline-item mr-4">
                    <i className="far fa-calendar mr-1" /> Dec 16, 2018
                  </li>
                  <li className="list-inline-item mr-4">
                    <i className="far fa-eye mr-1" /> 149 views
                  </li>
                </ul>
                <h3 className="fs-md-32 text-heading lh-141 mb-3">
                  <a
                    href="blog-details-1.html"
                    className="text-heading hover-primary"
                  >
                    Ten Benefits Of Rentals That May Change Your Perspective
                  </a>
                </h3>
                <p className="mb-4 lh-214">
                  ...
                  neque egestas congue quisque. Sed elementum tempus egestas
                  sed...
                </p>
              </div>
              <div className="card-footer bg-transparent p-0 border-0">
                <a
                  href="blog-details-1.html"
                  className="btn text-heading border btn-lg shadow-none btn-outline-light border-hover-light"
                >
                  Read more{" "}
                  <i className="far fa-long-arrow-right text-primary ml-1" />
                </a>
                <a
                  href="#"
                  className="btn text-heading btn-lg w-52px px-2 border shadow-none btn-outline-light border-hover-light rounded-circle ml-auto float-right"
                >
                  <i className="fad fa-share-alt text-primary" />
                </a>
              </div>
            </div>
            <div className="card border-0 pb-6 mb-6 border-bottom">
              <div className="position-relative bg-gray-04 px-3 px-md-12 d-flex justify-content-center z-index-1 pt-4">
                <div className="position-absolute pos-fixed-center fs-200 lh-1 z-index-2 text-lighter">
                  <svg className="icon icon-quote">
                    <use xlinkHref="#icon-quote" />
                  </svg>
                </div>
                <div className="position-relative z-index-3 pt-9 pb-7">
                  <p className="fs-22 text-heading lh-182 mb-6 text-center">
                    {" "}
                    We're on a mission to build a better future where technology
                    creates good jobs for everyone.
                  </p>
                  <p className="text-dark fs-13 lh-1 text-center mb-1 font-weight-bold">
                    Maggie Strickland
                    <span className="text-gray fs-12 lh-26 font-weight-normal d-inline-block ml-2">
                      / Web design
                    </span>
                  </p>
                </div>
            ...
            <div className="card border-0 pb-6 mb-6 border-bottom">
              <div className="position-relative d-flex flex-column card-img-top">
                <div className="hover-shine d-block">
                  <img
                  ...
                  <a
                    ...
                    className="d-inline-block m-auto position-absolute pos-fixed-center"
                    data-gtf-mfp="true"
                    data-mfp-options='{"type":"iframe"}'
                  >
                    <span className="text-primary bg-white w-78px h-78 rounded-circle position-relative play-animation d-flex align-items-center justify-content-center">
          ...
          <div
            className="col-lg-4 pl-xl-6 pr-xl-0 primary-sidebar sidebar-sticky"
            id="sidebar"
          >
            <div className="primary-sidebar-inner">
                  ...
                  <form>
                    <div className="position-relative">
                      ...
                      <div className="position-absolute pos-fixed-center-right">
                        <button
                          type="submit"
                          className="btn fs-15 text-dark shadow-none"
                        >
                ...
                <div className="card-body px-6 pt-5 pb-6">
                  ...
                  <ul className="list-group list-group-no-border">
                    <li className="list-group-item p-0">
                      <a
                        href="listing-with-left-sidebar.html"
                        className="d-flex text-body hover-primary"
                      >
                        <span className="lh-29">Creative</span>
                        <span className="d-block ml-auto">13</span>
                      </a>
                    </li>
                    <li className="list-group-item p-0">
                      <a
                        ...
                        className="d-flex text-body hover-primary"
                      >
                        <span className="lh-29">Rentals</span>
                        <span className="d-block ml-auto">21</span>
                      </a>
                    </li>
                    <li className="list-group-item p-0">
                      <a
                        ...
                        className="d-flex text-body hover-primary"
                      >
                        <span className="lh-29">Images and B-Roll</span>
                        <span className="d-block ml-auto">17</span>
                      </a>
                    </li>
                    <li className="list-group-item p-0">
                      <a
                        ...
                        className="d-flex text-body hover-primary"
                      >
                        <span className="lh-29">In the News</span>
                        <span className="d-block ml-auto">4</span>
                      </a>
                    </li>
                    <li className="list-group-item p-0">
                      <a
                        ...
                        className="d-flex text-body hover-primary"
                      >
                        <span className="lh-29">Real Estate</span>
                        <span className="d-block ml-auto">27</span>
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <div className="card mb-4">
                <div className="card-body px-6 pt-5 pb-6">
                  ...
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item px-0 pt-0 pb-3">
                      <div className="media">
                        <div className="position-relative mr-3">
                          <a
                            href="blog-details-1.html"
                            className="d-block w-100px rounded pt-11 bg-img-cover-center"
                            style={{
                          ...
                          <a
                            href="blog-grid-with-sidebar.html"
                            className="badge text-white bg-dark-opacity-04 m-1 fs-13 font-weight-500 bg-hover-primary hover-white position-absolute pos-fixed-top"
                          >
                            creative
                          </a>
                        </div>
                        <div className="media-body">
                          ...
                          <div className="text-gray-light">Dec 16, 2018</div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li className="list-group-item px-0 pt-2 pb-0">
                      <div className="media">
                        <div className="position-relative mr-3">
                          <a
                            href="blog-details-1.html"
                            className="d-block w-100px rounded pt-11 bg-img-cover-center"
                            style={{
                              backgroundImage: 'url("images/post-07.jpg")'
                            }}
                          ></a>
                          <a
                            href="blog-grid-with-sidebar.html"
              ...
              <div className="card mb-4">
                <div className="card-body px-6 pt-5 pb-6">
                  ...
                  <img
                    src="images/download-brochure.png"
                    alt="Download Brochure"
                  />
                  <div className="text-center mt-10 mb-2">
                    <a
                      href="#"
                      className="btn btn-lg bg-gray-01 bg-hover-accent btn-block text-heading"
                    >
                      Download now
                      <span className="text-primary d-inline-block ml-2">
                        <i className="far fa-arrow-circle-down" />
                      </span>
                    </a>
                  </div>
                </div>
  ...
  >
    <defs>
      ...
      <symbol id="icon-sofa" viewBox="0 0 41 32">
        ...
        <path d="M25.669 26.881l-10.242-0.003v1.661l20.582 0.006v-1.661z" />
      ...
      <symbol id="icon-f2" viewBox="0 0 32 32">
        ...
        <path d="M26.943 28.367h-22.348v-2.66h22.348v2.66zM5.487 27.475h20.565v-0.877h-20.565v0.877z" />
        ...
        <path d="M0 31.109h31.539v0.891h-31.539v-0.891z" />
        <path d="M19.781 7.18h-8.023v-4.593h8.023v4.593zM12.649 6.289h6.24v-2.811h-6.24v2.811z" />
        <path d="M15.324 0h0.891v2.97h-0.891v-2.97z" />
        <path d="M13.615 4.365h4.308v0.891h-4.308v-0.891z" />
        <path d="M12.898 8.68h0.891v15.894h-0.891v-15.894z" />
        <path d="M15.324 8.68h0.891v15.894h-0.891v-15.894z" />
        <path d="M17.75 8.68h0.891v15.894h-0.891v-15.894z" />
      </symbol>
