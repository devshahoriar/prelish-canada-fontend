...
const Services = () => {
  return (
    <>
      ...
      <main id="content">
        <section
          className="pt-2 pb-10 pb-lg-17 page-title bg-overlay bg-img-cover-center"
        ...
        >
          <div className="container">
            ...
            <h1
              className="fs-22 fs-md-42 mb-0 text-white font-weight-normal text-center pt-17 pb-13 lh-15 px-lg-16"
              data-animate="fadeInDown"
            >
              HomeID is an estate agency that helps people live in more
          ...
          <div className="container">
            <div className="card mt-n13 z-index-3 pt-10 border-0">
              <div className="card-body p-0">
                <h2 className="text-dark lh-1625 text-center mb-2">
                  Services Offered
                </h2>
            ...
            <div className="row mb-9">
              ...
              <div className="col-sm-6 col-lg-4 mb-6">
                <div className="card border-hover shadow-hover-lg-1 px-7 pb-6 pt-4 h-100 bg-transparent bg-hover-white">
                  <div className="card-img-top d-flex align-items-end justify-content-center">
                    <span className="text-primary fs-90 lh-1">
                      <svg className="icon icon-e4">
                        <use xlinkHref="#icon-e4" />
                      </svg>
                    </span>
                  </div>
                  <div className="card-body px-0 pt-6 pb-0 text-center">
              ...
              <div className="col-sm-6 col-lg-4 mb-6">
                <div className="card border-hover shadow-hover-lg-1 px-7 pb-6 pt-4 h-100 bg-transparent bg-hover-white">
                  <div className="card-img-top d-flex align-items-end justify-content-center">
                    <span className="text-primary fs-90 lh-1">
                      <svg className="icon icon-e5">
                        <use xlinkHref="#icon-e5" />
                      </svg>
                    </span>
                  </div>
                  <div className="card-body px-0 pt-6 pb-0 text-center">
              ...
              <div className="col-sm-6 col-lg-4 mb-6">
                <div className="card border-hover shadow-hover-lg-1 px-7 pb-6 pt-4 h-100 bg-transparent bg-hover-white">
                  <div className="card-img-top d-flex align-items-end justify-content-center">
                    <span className="text-primary fs-90 lh-1">
                      <svg className="icon icon-e6">
                        <use xlinkHref="#icon-e6" />
                      </svg>
                    </span>
                  </div>
                  <div className="card-body px-0 pt-6 text-center pb-0">
            ...
            <h2 className="text-heading mb-2 fs-22 fs-md-32 text-center lh-16 mxw-571 px-lg-8">
              Do You Have An Upcoming Real Esate Transaction?
            </h2>
            <p className="text-center mxw-670 mb-8">
              Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse
              suscorem ipsum dolor sit ametcipsum ipsumg consec tetur cing
              elitelit.
            </p>
