  ...
  return (
    <>
      ...
      <main id="content">
        ...
        <section className="pt-8 pb-11 bg-gray-01">
          <div className="container">
            <div className="row">
              <div
              ...
              <div className="col-lg-8 mb-8 mb-lg-0 order-1 order-lg-2">
                ...
                <div
                  className="py-5 px-4 border rounded-lg shadow-hover-1 bg-white mb-4"
                ...
                >
                  <div className="media flex-column flex-sm-row no-gutters">
                    ...
                    <div className="media-body mt-3 mt-sm-0">
                      ...
                      <p className="mb-1 font-weight-500 text-gray-light">
                        1421 San Pedro St, Los Angeles
                      </p>
                      <p className="fs-17 font-weight-bold text-heading mb-1">
                        $1.250.000
                      </p>
                      <p className="mb-2 ml-0">
                        Lorem ipsum dolor sit amet, sectetur cing elit uspe
                        ndisse suscorem ipsum dolor sitorem sit amet, sectetur
                        cing elit uspe ndisse suscorem
                      </p>
                    </div>
                  </div>
                  <div className="d-sm-flex justify-content-sm-between">
                    <ul className="list-inline d-flex mb-0 flex-wrap">
                      ...
                      <li
                        ...
                        title="Year"
                      >
                        <svg className="icon icon-year fs-18 text-primary mr-1">
                          <use xlinkHref="#icon-year" />
                        </svg>
                        2020
                      </li>
                    </ul>
                    <span className="badge badge-primary mr-xl-2 mt-3 mt-sm-0">
                      For Rent
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="d-sm-flex justify-content-sm-between">
                    ...
                    <span className="badge badge-indigo mr-xl-2 mt-3 mt-sm-0">
                      for Rent
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="media flex-column flex-sm-row no-gutters">
                    <div className="col-sm-3 mr-sm-5 card border-0 hover-change-image bg-hover-overlay mb-sm-5">
                      <img
                        src="images/properties-list-14.jpg"
                        className="card-img"
                        alt="Home in Metric Way"
                      />
                      <div className="card-img-overlay p-2">
                ...
                >
                  <div className="media flex-column flex-sm-row no-gutters">
                    <div className="col-sm-3 mr-sm-5 card border-0 hover-change-image bg-hover-overlay mb-sm-5">
                      <img
                        src="images/properties-list-15.jpg"
                        className="card-img"
                        alt="Garden Gingerbread House"
                      />
                      <div className="card-img-overlay p-2">
...
export default ListingWithLeftFilter
