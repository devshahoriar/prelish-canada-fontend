      ...
      <main id="content">
        <section className="pb-6 page-title shadow">
          <div className="container">
            ...
            <h1 className="fs-30 lh-16 mb-1 text-dark font-weight-600">
              Contact Us{' '}
            </h1>
          </div>
        </section>
            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="border-bottom pb-7">
                  <h2 className="text-heading mb-2 fs-22 lh-15 pr-6">
                  ...
                  <div className="row mt-8">
                      ...
                      <div className="media">
                        ...
                        <div className="media-body mt-3">
                          ...
                          <div className="row mb-1">
                            ...
                            <div className="col-9">
                              <a
                                href="tel:123-900-68668"
                                className="text-heading font-weight-500"
                              >
                                123 900 68668
                              </a>
                            </div>
                          ...
                          <div className="row mb-1">
                            ...
                            <div className="col-9">
                              <a
                                href="mailto:hello@preleasecanada.com"
                                className="text-body"
                              >
                                hello@preleasecanada.com
                              </a>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="col-md-6 mb-6">
                      <div className="media">
                        ...
                        <div className="media-body mt-3">
                          <h4 className="fs-16 lh-2 mb-1 text-dark">
                            Hour of operation
                          </h4>
                          <div className="row mb-1">
                            <div className="col-6">
                ...
                <div className="primary-sidebar-inner">
                  <div className="card mb-4">
                    <div className="card-body px-6 pt-5 pb-6">
                      <h3 className="card-title fs-16 lh-214 mb-2 text-dark">
                      ...
                      <form className="property-search">
                        ...
                        <div className="row">
                          <div className="col-6">
                            <button className="btn btn-lg btn-primary px-2 btn-block">
                              Search Homes
                            </button>
                          </div>
                          <div className="col-6">
                            <a
                              ...
                              className="d-block text-heading font-weight-600 d-flex align-items-center collapsed pr-2"
                              data-toggle="collapse"
                              data-target="#advanced-search-filters"
                              aria-expanded="true"
                              aria-controls="advanced-search-filters"
                            >
                              Advanced Search
                              <span className="text-primary d-inline-block fs-24 ml-2">
                        ...
                        >
                          ...
                          <div className="form-group">
                            <label
                              className="text-uppercase font-weight-500 letter-spacing-093 mb-1"
                              htmlFor="property-id"
                            >
                              Property ID
                            </label>
                          ...
                          <div className="collapse" id="other-feature-1">
                            <div className="py-2">
                  ...
                  <div className="card city-widget mb-4">
                    <div className="card-body px-6 pt-5 pb-6">
                      <h3 className="card-title fs-16 lh-214 text-dark mb-2">
                      ...
                      <div className="row no-gutters m-n1">
                        <div className="col-6 p-1">
                          <a
                            href="listing-with-left-sidebar.html"
                            className="card hover-zoom-in"
                          >
                            <div
                              className="card-img bg-img"
                              style={{
                                backgroundImage:
                                  'url("images/small-los-angeles.jpg")',
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                              }}
                            />
                            <div className="card-img-overlay bg-gradient-3 rounded-lg d-flex align-items-end">
                              <p className="card-text font-weight-500 lh-1 text-white">
                                Los Angeles
                              </p>
                            </div>
                          </a>
                        ...
                        <div className="col-6 p-1">
                          ...
                          >
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  'url("images/small-south-florida.jpg")',
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                              }}
                            />
                        ...
                        <div className="col-6 p-1">
                          ...
                          >
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  'url("images/small-the-hamptons.jpg")',
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                              }}
                            />
                        ...
                        <div className="col-6 p-1">
                          ...
                          >
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  'url("images/small-greater-boston.jpg")',
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                              }}
                            />
        ...
        <section
          className="py-8 pt-11 pb-lg-13 position-relative bg-img-cover-center"
          style={{ backgroundImage: 'url("images/bg-contact-form-01.jpg")' }}
        >
          <div className="container">
            <h2 className="text-white mxw-751 text-center fs-22 fs-md-34 lh-15 font-weight-normal mb-8">
              Subscribe to newsletter to receive exclusive offers and the latest
              news
            </h2>
            <form>
              <div className="input-group input-group-lg mb-6 mxw-571">
                <input
                  type="text"
