...
const AgencyList = () => {
  return (
    <>
      ...
      <main id="content">
        <section
          className="pt-2 page-title bg-overlay"
          style={{
        ...
        >
          <div className="container">
            ...
            <h1
              className="fs-32 mb-0 text-white font-weight-500 text-center pt-10 pb-9 lh-17 mxw-478"
        ...
        <section className="bg-secondary">
          <div className="container">
            <div className="py-2">
              <form className="d-none d-md-flex row no-gutters px-n1 flex-wrap align-items-end">
                <div className="form-group py-1 col-md-3 px-1 mb-0">
                  <label htmlFor="region02" className="sr-only">
                    Region
                  </label>
                  <select
                    ...
                    name="region"
                    id="region02"
                    data-style="bg-white btn-lg rounded-lg"
                    title="Region"
                  >
                ...
                <div className="form-group py-1 col-md-7 px-1 mb-0">
                  <label htmlFor="search02" className="sr-only">
                    Search
                  </label>
                  <div className="input-group input-group-lg">
                    <div className="input-group-prepend mr-n1">
                      <span className="fs-18 input-group-text bg-white border-0">
              ...
              <form className="d-block d-md-none">
                <div className="d-flex align-items-center">
                  <a
                    className="text-white hover-primary d-inline-block fs-24 lh-1 mr-5"
                    data-toggle="collapse"
                    href="#collapseMobileSearch-02"
                    role="button"
                    aria-expanded="false"
                    aria-controls="collapseMobileSearch-02"
                  >
                    <i className="fal fa-cog" />
                  </a>
                  <div className="form-group mb-0 w-100">
                    <label htmlFor="search04" className="sr-only">
                      Search
                    </label>
                    <div className="input-group input-group-lg">
                      <input
                        ...
                        name="search"
                      />
                      <div className="input-group-append ml-n1">
                        <span className="fs-18 input-group-text bg-white border-0">
                          <i className="fal fa-search" />
                        </span>
                      </div>
                ...
                <div className="collapse" id="collapseMobileSearch-02">
                  <div className="card card-body border-0 pr-0 pl-8 bg-transparent">
                    <div className="form-group">
                      <label htmlFor="region04" className="sr-only">
                        Region
                      </label>
                      <select
                        className="form-control selectpicker"
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-8 mb-6 mb-lg-0">
                <div className="row align-items-sm-center mb-6">
                  <div className="col-sm-6 mb-6 mb-sm-0">
                    <h2 className="fs-15 text-dark mb-0">
                      We found <span className="text-primary">45</span> agencies
                      available for you
                    </h2>
                  </div>
                  <div className="col-sm-6">
                    <div className="d-flex align-items-center justify-content-sm-end">
                      <div className="input-group border rounded input-group-lg w-auto mr-6">
                        ...
                        <select
                          className="form-control border-0 bg-transparent shadow-none p-0 selectpicker"
                      ...
                      <div className="d-none d-md-block list-layout">
                        ...
                        <a
                          href="agency-grid.html"
                          className="fs-sm-18 text-muted ml-5"
                        >
                ...
                <div className="card shadow-hover-lg-xs-4 border border-sm-0 mb-4">
                  <div className="row no-gutters align-items-center">
                    <div className="col-sm-4 border-sm rounded-0 rounded-lg-top-left card-img">
                    ...
                    <div className="col-sm-8">
                      <div className="card-body px-6 py-6 py-sm-0 border-top border-sm-0">
                        <a href="agency-details-1.html">
                          <h6 className="card-title text-dark lh-213 mb-0 hover-primary">
                            Eco House Company
                          </h6>
                        </a>
                        ...
                        <ul className="list-group list-group-no-border">
                          <li className="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                            <span className="col-sm-3 p-0 fs-13 mb-1 mb-sm-0">
                              Office
                            </span>
                            <span className="col-sm-9 p-0 text-heading font-weight-500">
                              123 900 68668
                            </span>
                          </li>
                          <li className="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                          ...
                          <li className="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-3 pb-0">
                            ...
                            <span className="col-sm-9 p-0">
                              ecohouse@preleasecanada.com
                            </span>
                          </li>
                          <li className="list-group-item d-flex align-items-sm-center lh-114 row m-0 px-0 pt-4 pb-0">
                            <span className="col-sm-3 p-0 fs-13 mb-1 mb-sm-0">
                              Social
                            </span>
                            <ul className="col-sm-9 list-inline text-gray-lighter m-0 p-0 z-index-2">
                ...
                <div className="primary-sidebar-inner">
                  <div className="card mb-4">
                    <div className="card-body text-center pt-7 pb-6 px-0">
                      ...
                      />
                      <div className="text-dark mb-6 mt-n2 font-weight-500">
                        Want to become an
