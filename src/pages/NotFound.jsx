        ...
        <section className="pt-9 pb-10">
          <div className="container">
            <div className="text-center mb-15">
              ...
              <h1 className="fs-30 lh-16 text-dark font-weight-600 mb-5">
              ...
              <form>
                <div className="input-group mb-6 mxw-670 shadow-xxs-2 custom-input-group mb-2">
                  <div className="input-group-prepend">
                    <button
                      className="btn shadow-none text-dark fs-18"
                      type="button"
                    >
            ...
            <div className="row">
              <div className="col-lg-6 mb-6">
                <h2 className="fs-22 lh-15 text-dark border-bottom pb-2 mb-2 pr-lg-7">
                  Latest Listings
                </h2>
                <ul className="list-unstyled row">
                  <li className="col-md-6 lh-26">
                    <a
                      ...
                      className="text-body hover-dark"
                    >
                      Los Angeles Offices
                    </a>
                  </li>
              ...
              <div className="col-lg-6 mb-6">
                <h2 className="fs-22 lh-15 text-dark border-bottom pb-2 mb-2">
                  Latest Articles
                </h2>
                <ul className="list-unstyled row">
                  <li className="col-md-6 lh-26">
