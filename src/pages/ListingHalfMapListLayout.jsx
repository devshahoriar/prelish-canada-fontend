...
const ListingHalfMapListLayout = () => {
  return (
    <>
      ...
      <main id="content">
        <section className="position-relative">
          <div className="container-fluid px-0 map-margin">
            <div className="row no-gutters">
              <div className="col-xl-6 col-xxl-5 px-3 px-xxl-6 pt-7 order-2 order-xl-1 pb-11">
                <div className="row align-items-sm-center mb-6">
                  <div className="col-md-6 col-xl-5 col-xxl-6">
                    <h2 className="fs-15 text-dark mb-0">
                      We found <span className="text-primary">45</span>{' '}
                ...
                <div className="row">
                  <div className="col-12">
                    <div
                      className="card mb-8 mb-lg-6 border-0"
                      data-animate="fadeInUp"
                    >
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            className="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                            style={{
                              backgroundImage:
                                'url("images/properties-list-06.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              ...
                              <div className="mt-auto d-flex hover-image">
                                ...
                                <ul className="list-inline mb-0 d-flex align-items-end mr-n3">
                                  ...
                                  <li
                                    className="list-inline-item h-32  mr-3"
                                    data-toggle="tooltip"
                                    title="Compare"
                                  >
                                    <a
                          ...
                          <div className="card-body p-0">
                            <h2 className="card-title my-0">
                              <a
                                ...
                                className="fs-16 lh-2 text-dark hover-primary d-block"
                              >
                                Home in Metric Way
                              </a>
                            </h2>
                            <p className="card-text mb-1 font-weight-500 text-gray-light">
                              1421 San Pedro St, Los Angeles
                            </p>
                            <p className="card-text mb-2 ml-0">
                              Lorem ipsum dolor sit amet, sectetur cing elit
                              uspe ndisse suscorem ipsum dolor sitorem sit amet,
                              sectetur cing elit uspe ndisse suscorem
                            </p>
                      ...
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url("images/properties-list-16.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              <div>
                      ...
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url("images/properties-list-05.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              <div>
                      ...
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url("images/properties-list-17.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              <div>
                      ...
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url("images/properties-list-18.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              <div>
                      ...
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url("images/properties-list-19.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              <div>
                      ...
                      <div className="row no-gutters">
                        <div className="col-md-6 mb-5 mb-md-0 pr-md-6">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                'url("images/properties-list-20.jpg")',
                            }}
                          >
                            <div className="card-img-overlay p-2 d-flex flex-column">
                              <div>
              ...
              <div
                className="col-xl-6 col-xxl-7 order-1 order-xl-2 primary-map map-sticky overflow-hidden"
                id="map-sticky"
              >
                <div className="primary-map-inner">
                  <div
                    className="mapbox-gl map-grid-property-01 xl-vh-100"
                    id="map"
        ...
        <div className="d-none" id="template-properties">
          <div
            ...
            data-icon-marker="images/googlle-market-02.png"
            ...
            <div className="position-relative">
              <div className="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
                <div className="col-3 mr-2 card border-0">
                  <img
                    src="images/properties-list-03.jpg"
                    className="card-img"
                ...
                <div className="media-body">
                  <h2 className="my-0">
                    <a
                      href="single-property-1.html"
                      className="fs-13 lh-2 text-dark hover-primary d-block"
                    >
                      Home in Metric Way
                    </a>
                  </h2>
                  <p className="mb-0 font-weight-500 text-gray-light">
                    1421 San Pedro St, Los Angeles
                  </p>
          ...
          >
            <div className="position-relative">
              <div className="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
                <div className="col-3 mr-2 card border-0">
                  <img
                    src="images/properties-list-04.jpg"
                    className="card-img"
                    alt="Home in Metric Way"
                  />
                </div>
          ...
          <div
            className="marker-item"
            data-icon-marker="images/googlle-market-03.png"
          ...
          >
            <div className="position-relative">
              <div className="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
                <div className="col-3 mr-2 card border-0">
                  <img
                    src="images/properties-list-11.jpg"
                    className="card-img"
                    alt="Home in Metric Way"
                  />
                </div>
          ...
          >
            <div className="position-relative">
              <div className="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
                <div className="col-3 mr-2 card border-0">
                  <img
                    src="images/properties-list-12.jpg"
                    className="card-img"
                    alt="Home in Metric Way"
                  />
                </div>
          ...
          >
            <div className="position-relative">
              <div className="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
                <div className="col-3 mr-2 card border-0">
                  <img
                    src="images/properties-list-13.jpg"
                    className="card-img"
                    alt="Home in Metric Way"
                  />
                </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-6 mb-md-0">
              <a className="d-block mb-2 footer-logo-white" href="#">
...
export default ListingHalfMapListLayout
