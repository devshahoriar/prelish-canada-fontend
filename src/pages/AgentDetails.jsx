        ...
        <div className="row">
          ...
          <div className="col-md-7">
            <div className="pl-md-10 pr-md-8 py-7">
              <h2 className="fs-30 text-dark font-weight-600 lh-16 mb-0">
                Blanche Gordon
              </h2>
              <p className="fs-16 font-weight-500 lh-213 mb-4">
              ...
              <p className="mb-6">
                ...
                suscorem ipsum dolor sit ametcipsum dolor sit t, consec tetur
                atetur cing elit. Suspe ndisse susco rem ipsum dolor sit
                ametcipsum doloamet.
              </p>
              <hr className="mb-4" />
              <div className="row">
                <div className="col-sm-6 mb-4">
                  ...
                  <p className="text-heading font-weight-500 mb-0 lh-13">
                    +98 0390 909 039
                  </p>
                  <p className="text-heading font-weight-500 mb-0 lh-13">
                    +98 0900 098 888
          ...
          <div className="col-lg-8 mb-6 mb-lg-0">
              ...
              <div className="tab-content shadow-none pt-7 pb-0 px-6 bg-white">
                <div id="collapse-tabs-accordion-01">
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6 mb-7">
                              <div className="card border-0">
                                <div className="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                  <img
                                    src="images/properties-grid-49.jpg"
                                    alt="Home in Metric Way"
                                  />
                                  <div className="card-img-overlay d-flex flex-column">
                                    <div className="mb-auto">
                            ...
                            <div className="col-md-6 mb-7">
                              <div className="card border-0">
                                <div className="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                  <img
                                    src="images/properties-grid-19.jpg"
                                    alt="Home in Metric Way"
                                  />
                                  <div className="card-img-overlay d-flex flex-column">
                                    <div className="mb-auto">
                  ...
                  >
                    <div className="card border-0 bg-transparent">
                      <div
                        className="card-header border-0 d-block d-md-none bg-transparent p-0"
                        id="headingSale-01"
                      >
                        <h5 className="mb-0">
                          <button
            ...
            <div className="card border-0 mb-4">
              <div className="card-body p-6">
                  ...
                  <div className="media-body">
                    <div className="row mb-1 align-items-center">
                      <div className="col-sm-6 mb-2 mb-sm-0">
                        <p className="mb-0 text-heading fs-16 font-weight-500">
                          Dollie Horton
                        </p>
                ...
                <a
                  href="#"
                  className="btn btn-lg text-heading bg-hover-light border fs-14 px-5"
                >
                  View more{" "}
          ...
          <div className="modal-body pb-6">
            ...
            <div className="form-group mb-2">
              <textarea
                className="form-control border-0"
                rows={4}
                defaultValue={"Hello, I'm interested in Villa Called Archangel"}
              />
            </div>
            <div className="form-group form-check mb-4">
              <input
                ...
                id="exampleCheck3"
              />
              <label className="form-check-label fs-13" htmlFor="exampleCheck3">
