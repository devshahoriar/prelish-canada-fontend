...
const Packages = () => {
  return (
    <>
      ...
      <main id="content">
        <section className="pb-4 shadow-xs-5 mt-13">
        ...
        <section className="py-8">
          <div className="container">
            <h4 className="mb-2 fs-22 lh-15 text-heading">
              Choose the packages that’s right for your business{' '}
            </h4>
            <p className="mb-6 pb-1">
              Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse
              suscorem ipsum dolor sit ametcipsu
            </p>
            <div className="row">
              <div className="col-xl-3 col-sm-6 mb-6">
                <div className="card bg-gray-01 border-0 p-4 overflow-hidden">
                  <div className="card-header bg-transparent p-0">
                    <p className="fs-15 font-weight-bold text-heading mb-0">
                      Free <span className="font-weight-500">Pack</span>
                    </p>
                    <p className="fs-32 font-weight-bold text-heading lh-15 mb-1">
                      Free
                    </p>
                  </div>
                  <div className="card-body p-0">
                    <ul className="list-unstyled pt-2 mb-2">
                      <li className="d-flex justify-content-between">
                        <p className="text-gray-light mb-0">Expiration Date</p>
                        <p className="font-weight-500 text-heading mb-0">
                          10 days
                        </p>
                      </li>
                      <li className="d-flex justify-content-between">
                        <p className="text-gray-light mb-0">Property Listing</p>
                        <p className="font-weight-500 text-heading mb-0">10</p>
                      </li>
                      <li className="d-flex justify-content-between">
                        <p className="text-gray-light mb-0">Listings</p>
                        <p className="font-weight-500 text-heading mb-0">5</p>
                      </li>
                    </ul>
                    <a
                      href="#"
                      className="btn btn-primary btn-block h-52 pl-4 pr-3 d-flex justify-content-between align-items-center"
                    >
                      Choose this pack
              ...
              <div className="col-xl-3 col-sm-6 mb-6">
                <div className="card bg-gray-01 border-0 p-4 overflow-hidden">
                  <div className="card-header bg-transparent p-0">
                    <p className="fs-15 font-weight-bold text-heading mb-0">
                      Standard <span className="font-weight-500">Pack</span>
                    </p>
                    <p className="fs-32 font-weight-bold text-heading lh-15 mb-1">
                      $30
                    </p>
                  ...
                  <div className="card-body p-0">
                    <ul className="list-unstyled pt-2 mb-2">
                      ...
                      <li className="d-flex justify-content-between">
                        <p className="text-gray-light mb-0">Property Listing</p>
                        <p className="font-weight-500 text-heading mb-0">20</p>
                      </li>
                      <li className="d-flex justify-content-between">
                        <p className="text-gray-light mb-0">Listings</p>
                        <p className="font-weight-500 text-heading mb-0">10</p>
              ...
              <div className="col-xl-3 col-sm-6 mb-6">
                <div className="card bg-gray-01 border-0 p-4 overflow-hidden">
                  <div className="card-header bg-transparent p-0">
                    ...
                    <span className="fs-13 font-weight-500 text-white text-uppercase custom-packages">
                      Popular
                    </span>
                  </div>
                  <div className="card-body p-0">
              ...
              <div className="col-xl-3 col-sm-6 mb-6">
                <div className="card bg-gray-01 border-0 p-4 overflow-hidden">
                  <div className="card-header bg-transparent p-0">
                    <p className="fs-15 font-weight-bold text-heading mb-0">
                      Gold <span className="font-weight-500">Pack</span>
                    </p>
                    <p className="fs-32 font-weight-bold text-heading lh-15 mb-1">
                      $200
                    </p>
