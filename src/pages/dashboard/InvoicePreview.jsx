                ...
                <div className="card card-body main-invoice-info p-6">
                  <div className="row mb-7">
                    ...
                    <div className="col-sm-6 align-self-center mt-3 text-sm-right">
                      <p className="mb-0">
                        <span className="text-heading font-weight-500">
                          Invoice Date :{" "}
                        </span>
                        <span className="inv-date">20 Aug 2020</span>
                      </p>
                      <p className="mb-0">
                        <span className="text-heading font-weight-500">
                          Due Date :{" "}
                        </span>{" "}
                        <span className="inv-date">26 Aug 2020</span>
                      </p>
                    </div>
                  </div>
                  <div className="border-top pt-7 mb-7">
                    <div className="row">
                      <div className="col-xl-8 col-md-6 col-sm-4 align-self-center">
                        <h6 className="card-title mb-5 text-heading fs-22 lh-15">
                          Invoice To
                        </h6>
                      </div>
                      ...
                      <div className="text-sm-right">
                        <div className="row">
                          ...
                          <div className="col-sm-8 col-7 grand-total-title mt-4">
                            <h4 className="text-heading fs-22 lh-15">
                              Grand Total :{" "}
                            </h4>
                          </div>
                  ...
                  <div className="row">
                    <div className="col-xl-12 col-md-3 col-sm-6 mb-3">
                      <a
                        ...
                        className="btn btn-primary btn-send btn-block"
                      >
                        Send Invoice
                      </a>
                    </div>
                    <div className="col-xl-12 col-md-3 col-sm-6 mb-3">
                      <a
                        href="javascript:void(0);"
                        className="btn btn-secondary btn-print invoice-action-print btn-block"
                      >
                        Print
                      </a>
                    </div>
                    <div className="col-xl-12 col-md-3 col-sm-6 mb-3">
                      <a
                        href="javascript:void(0);"
                        className="btn btn-success btn-download btn-block"
                      >
                        Download
                      </a>
                    </div>
                    <div className="col-xl-12 col-md-3 col-sm-6 mb-3">
                      <a
                        href="dashboard-edit-invoice.html"
                        className="btn btn-dark btn-edit btn-block"
                      >
                        Edit
                      </a>
                    </div>
