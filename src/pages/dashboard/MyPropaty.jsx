                  ...
                  <table className="table table-hover bg-white border rounded-lg">
                    ...
                    <tbody>
                      ...
                      <tr className="shadow-hover-xs-2 bg-hover-white">
                        <td className="align-middle pt-6 pb-4 px-6">
                          <div className="media">
                            <div className="w-120px mr-4 position-relative">
                              ...
                              <span className="badge badge-primary position-absolute pos-fixed-top">
                                for sale
                              </span>
                            </div>
                            <div className="media-body">
                        ...
                        <td className="align-middle">30 December, 2019</td>
                        <td className="align-middle">
                          <span className="badge text-capitalize font-weight-normal fs-12 badge-pink">
                            published
                          </span>
                        </td>
                        <td className="align-middle">2049</td>
                        ...
                        <td className="align-middle pt-6 pb-4 px-6">
                          <div className="media">
                            <div className="w-120px mr-4 position-relative">
                              <a href="single-property-1.html">
                                <img
                                  src="/images/my-properties-03.jpg"
                        ...
                        <td className="align-middle pt-6 pb-4 px-6">
                          <div className="media">
                            <div className="w-120px mr-4 position-relative">
                              <a href="single-property-1.html">
                                <img
                                  src="/images/my-properties-04.jpg"
