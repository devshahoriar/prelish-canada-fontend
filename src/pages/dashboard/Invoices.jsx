                    ...
                    <li className="list-group-item pt-6 pb-4">
                      ...
                      <ul className="list-group list-group-no-border rounded-lg">
                          ...
                          >
                            <span className="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
                              <svg className="icon icon-my-properties">
                                <use xlinkHref="#icon-my-properties" />
                              </svg>
                            </span>
                        ...
                        <li className="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                          ...
                          >
                            <span className="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
                              <svg className="icon icon-save-search">
                                <use xlinkHref="#icon-save-search" />
                              </svg>
                            </span>
                            <span className="sidebar-item-text">
                              Save Search
            ...
            <main id="content" className="bg-gray-01">
              <div className="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10 invoice-listing">
                  ...
                  <div className="row">
                    <div className="col-sm-12 col-md-6 d-flex justify-content-md-start justify-content-center">
                      <div className="d-flex form-group mb-0 align-items-center">
                        <label
                          htmlFor="invoice-list_length"
                          className="d-block mr-2 mb-0"
                        >
                          Results:
                        </label>
                        <select
                          ...
                          className="form-control form-control-lg mr-2 selectpicker"
                    ...
                    <div className="col-sm-12 col-md-6 d-flex justify-content-md-end justify-content-center mt-md-0 mt-3">
                      <div className="input-group input-group-lg bg-white mb-0 position-relative mr-2">
                        <input
                          type="text"
                          className="form-control bg-transparent border-1x"
                          placeholder="Search..."
                          aria-label=""
                        ...
                        <div className="input-group-append position-absolute pos-fixed-right-center">
                          <button
                            className="btn bg-transparent border-0 text-gray lh-1"
                            type="button"
                          >
                ...
                <div className="table-responsive">
                  <table
                    id="invoice-list"
                    className="table table-hover bg-white border rounded-lg"
                  >
                    <thead>
                      <tr role="row">
                        <th className="no-sort py-6 pl-6">
                    ...
                    <tbody>
                      <tr role="row">
                        <td className="checkbox-column py-6 pl-6">
                          <label className="new-control new-checkbox checkbox-primary m-auto">
                            <input
                              type="checkbox"
                        ...
                        <td className="align-middle">
                          <div className="d-flex align-items-center">
                            <div className="usr-img-frame mr-2 rounded-circle">
                              <img
                                alt="avatar"
                                className="img-fluid rounded-circle w-30px"
                        ...
                        <td className="align-middle">
                          <span className="badge badge-green text-capitalize">
                            Paid
                          </span>
                        </td>
                        <td className="align-middle">
                      ...
                      <tr role="row">
                        <td className="checkbox-column py-6 pl-6 align-middle">
                          <label className="new-control new-checkbox checkbox-primary  m-auto">
                            <input
                              type="checkbox"
                              className="new-control-input child-chk select-customers-info"
                        ...
                        <td className="align-middle">
                          <div className="d-flex align-items-center">
                            <div className="usr-img-frame mr-2 rounded-circle">
                              <img
                                alt="avatar"
                                className="img-fluid rounded-circle w-30px border-light"
                      ...
                      <tr role="row">
                        ...
                        <td className="align-middle">
                          <span className="badge badge-yellow text-capitalize">
                            Pending
                          </span>
                        </td>
                        <td className="align-middle">
