  ...
  <main id="content">
    ...
    <section className="pt-8 pb-13 bg-gray-01">
      <div className="container">
        <div className="row">
          <div
            className="col-lg-4 primary-sidebar sidebar-sticky order-1 order-lg-0"
            id="sidebar"
          >
                ...
                <div className="card-body px-6 pt-5 pb-6">
                  ...
                  <form>
                    <div className="form-group mb-2">
                      <select
                        className="form-control border-0 shadow-none selectpicker"
                        name="company"
                        title="Company"
                        data-style="btn-lg px-3"
                      >
                    ...
                    <div className="form-row mb-2">
                      <div className="col-6 form-group">
                        <select
                          ...
                          name="language"
                          title="Language"
                          data-style="btn-lg rounded-lg px-3"
                        >
            ...
            <div className="row align-items-sm-center mb-7">
              <div className="col-sm-6 mb-6 mb-sm-0">
                <h2 className="fs-15 text-dark mb-0">
                  We found <span className="text-primary">45</span> agents
                  available for you
                </h2>
              </div>
            ...
            <div className="card p-2 border-0 mb-4 d-block">
              <div className="row no-gutters">
                <div className="col-sm-4 pr-0 pr-sm-1">
                  <a
                    href="agent-details-1.html"
                    className="d-block hover-shine"
                  >
                    <img
                      src="images/agent-12.jpg"
                      className="card-img"
                      alt="Diego Garcia"
                    />
                  </a>
                ...
                <div className="col-sm-8">
                  <div className="card-body pl-0 pl-sm-7">
                    <a
                      href="agent-details-1.html"
                      className="card-title d-block fs-16 lh-2 text-dark font-weight-500 hover-primary mb-0"
                    >
                      Diego Garcia
                    </a>
                    ...
                    <a href="tel:123-900-68668" className="d-block">
                      ...
                      <span className="d-inline-block ml-2 text-body">
                        123 900 68668
                      </span>
                    </a>
                    <a
                      href="mailto:oliverbeddows@preleasecanada.com"
                      className="d-block"
                    >
                      <span className="text-primary">
                      ...
                      <span className="d-inline-block ml-2 text-body">
                        oliverbeddows@preleasecanada.com
                      </span>
                    </a>
                    <div className="">
                      <span className="text-primary">
                    ...
                    <ul className="list-inline text-gray-lighter mt-4 mb-0">
                      <li className="list-inline-item">
                        <a
                          href="#"
                          className="w-32px h-32 rounded-lg bg-hover-primary bg-white hover-white text-body d-flex align-items-center justify-content-center border border-hover-primary"
                        >
